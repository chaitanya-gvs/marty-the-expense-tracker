    ...
    <>
      <div className="flex flex-wrap items-center gap-2 mb-4 md:flex-nowrap md:justify-between md:gap-3">
        ...
        <select
          ...
          className="flex-1 md:flex-initial h-11 md:h-auto text-base md:text-xs bg-transparent text-muted-foreground border border-border rounded-md px-2 py-1 cursor-pointer hover:border-border/80 focus:outline-none"
