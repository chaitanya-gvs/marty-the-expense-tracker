...
def _convert_db_transaction_to_response(transaction: Dict[str, Any]) -> TransactionResponse:
    ...
    # Format transaction_time as HH:MM:SS string if present
    ...
    return TransactionResponse(
        ...
        is_recurring=bool(transaction.get('is_recurring')) if transaction.get('is_recurring') is not None else False,
        recurring_key=transaction.get('recurring_key'),
        recurrence_period=transaction.get('recurrence_period'),
