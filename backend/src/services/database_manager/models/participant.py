...
from sqlalchemy import BigInteger, DateTime, Index, Numeric, String, Text, UniqueConstraint, func
...
class Participant(Base):
    ...
    splitwise_balance: Mapped[Optional[Decimal]] = mapped_column(Numeric(12, 2), nullable=True)
    balance_synced_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
